...
[![shipthatcode — Erlang Intermediate](https://api.shipthatcode.com/cert/f0228f46e2e178810b1e8dadd6d8fc20.svg)](https://shipthatcode.com/courses/erlang-intermediate)

My working repo for [Erlang Intermediate](https://shipthatcode.com/courses/erlang-intermediate) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Erlang Intermediate"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/erlang-intermediate) ("Work in your own editor" → **Link repo**). Done — you never do this again.
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/erlang-intermediate) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
